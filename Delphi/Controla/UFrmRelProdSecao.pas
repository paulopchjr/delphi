...
procedure TfrmRelProdSecao.edtCodFinalChange(Sender: TObject);
begin
  inherited;
limparTabela
end;

procedure TfrmRelProdSecao.edtCodInicioChange(Sender: TObject);
begin
  inherited;
 limparTabela;
end;

procedure TfrmRelProdSecao.limparTabela;
var
